...
YesBtn.addEventListener('click',function () {
    ...
    alert('💌Y DE ULTIMAS, QUIERO QUE DECIRTE QUE ERES UNA PERSONA QUE ADMIRO MUCHO ERES UNA CHICA MUY VALIENTE,MUY INTELIGENTE,UNA PERSONA MADURA ANTE CUALQUIER SITUACION Y POR MUCHAS RAZONES MERECES LO MEJOR DE LO MEJOR 💌')
    alert('💞TE💟QUIERO....💞') 
    alert('💓')
});
